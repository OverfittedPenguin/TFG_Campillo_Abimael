...
\section{Budget}
The following table is a summary of the breakdown budget of the project worded in this report. A detailed version of the budget can be seen in the proper budget's document facilitated along to this document. As can be seen, the overall estimated cost of the project has been $\mathbf{8935.59 \ }$ €.

\begin{table}[H]
    \caption{Budget executive sumamry. Own source.}
    \begin{tabular}{clllcc}
        \hline
        \multicolumn{5}{l}{Personnel Costs} & 7737.12 € \\ \hline
        & \multicolumn{3}{l}{GNC Intern Engineer (360h)} & 4417.20 € &  \\
        & \multicolumn{3}{l}{GNC Senior Engineer (36h)} & 1249.92 € &  \\
        & \multicolumn{3}{l}{Aerospace Senior Engineer (72h)} & 2070.00 € &  \\ \hline
        \multicolumn{5}{l}{Hardware Costs} & 386.14 € \\ \hline
        & \multicolumn{3}{l}{MSI Modern 15 16GB 512GB -  amortised 2 years} & 218.54 € &  \\
        & \multicolumn{3}{l}{Apple IPad Air 11" 128 GB - amortised 5 months} & 129.80 € &  \\
        & \multicolumn{3}{l}{Apple Pencil - amortised 5 months} & 37.80 € &  \\ \hline
        \multicolumn{5}{l}{Contingency Margin (10\%)} & 812.33 € \\ \hline
        \multicolumn{5}{l}{\textbf{Total Cost}} & \textbf{8935.59 €} \\ \hline
    \end{tabular}
    \label{tab:Budget}
\end{table}
