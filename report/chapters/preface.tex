...
\begin{itemize}
    ...
    \item A budget and an impact analysis of the whole project.
\end{itemize}
...
\begin{itemize}
    ...
    \item High-fidelity fluid modelling of the water-drop print or the fire plume behaviour.
...
From my viewpoint as the author of the thesis and the project, I was thrilled to be able to contribute to a real project, such as Singular Aircraft and the guidance of manoeuvres in the Flyox \gls{uas}, as well as to learn about a subject that was new to me and develop my skills in it.
