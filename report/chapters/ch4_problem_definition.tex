...
\begin{table}[H]
    ...
    \hline
        ...
        $d_{d,min}$ & \begin{tabular}[c]{@{}l@{}}Minimum discharge distance needed. \\ $d_{d,min} \coloneqq V_{TP}\cdot t_{d,min}$\end{tabular} & 2 & {[}m{]} \\
        $d_{d,max}$ & \begin{tabular}[c]{@{}l@{}}Maximum discharge distance. \\$d_{d,max} \coloneqq V_{TP}\cdot t_{d,max}$ \end{tabular}& 2 & {[}m{]} \\
