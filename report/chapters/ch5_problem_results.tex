...
\begin{itemize}
    \item Firstly, a disturbance has been created by reducing or extending the discharge's duration. It has been observed that this system is apparently robust to instantaneous disturbances; nonetheless, control is softer and smoother in nominal conditions, which also means flatter state trajectories. Certainly, states are a consequence of control variables.
