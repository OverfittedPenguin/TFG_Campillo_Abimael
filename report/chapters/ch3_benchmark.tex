...
\begin{equation}
    \begin{aligned}
        \mathbf{w}_{lb} & \coloneqq \mathbf{1}_{N} \otimes \mathbf{x_{lb}} \\
        \mathbf{w}_{ub} & \coloneqq \mathbf{1}_{N} \otimes \mathbf{x_{ub}}
    \end{aligned}
